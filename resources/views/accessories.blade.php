...
<body>
  @include('layouts.navbar')
    ...
    <div class="bbooxx">
        ...
        <div class="overlay">
          <h1>Custom Accessories Manufacturer</h1>
        </div>
      </div>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center">
                ...
                <div class="col-md-5 text-md-end left-box">
                    <h1 class="custom-heading">Premium Custom Accessories Crafted in Sialkot, Pakistan</h1>
                ...
                <div class="col-md-5 text-md-start right-box">
                    <p class="custom-text">We are a leading custom apparel manufacturer, exporter, and distributor based in Sialkot. Delivering top-quality, affordable custom team kits to meet your needs.</p>
